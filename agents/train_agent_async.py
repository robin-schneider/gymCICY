            ...
            if done or reset or global_t >= steps or training_done.value:
                ...
                if info:
                    ...
                    with open(filename, 'a') as f:
                        #f.write('Global step {}, local step {}, episode reward {}.\n'.format(global_t, local_t, episode_r))
                ...
                # add additional argument for when the entropy goes to zero
                #if agent.average_entropy < 1e-5:
                #    logger.warning('Average entropy dropped below 1e-5. Expermient will be terminated.')
                #    break
